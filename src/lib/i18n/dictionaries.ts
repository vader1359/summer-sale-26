...
const dictionaries: Record<Language, Dictionary> = {
  vi: {
    ...
    cartModal: {
      ...
      description: "Để lại thông tin để nhận tư vấn chương trình Summer Sale 2026 và các chương trình khuyến mãi khác",
      name: "Họ và tên",
      phone: "Số điện thoại",
      email: "Email",
      namePlaceholder: "Nhập họ và tên",
      ...
      submitting: "Đang gửi...",
      successTitle: "Cảm ơn bạn!",
      successDescription: "Yêu cầu đã được gửi thành công. Chúng tôi sẽ liên hệ trong thời gian sớm nhất.\n\nLưu ý: Do chương trình khuyến mãi đang áp dụng trên cả kênh online lẫn offline, trạng thái tồn kho của sản phẩm thay đổi liên tục từng phút. Để đảm bảo quyền lợi và không bỏ lỡ ưu đãi, bạn nên nhắn tin trực tiếp qua Zalo của nanoHome. Đội ngũ trực chat sẽ ưu tiên hỗ trợ bạn kiểm tra hàng và giữ đơn nhanh nhất.",
  ...
  en: {
    ...
    cartModal: {
      ...
      collapsedCta: "CLICK HERE",
      description: "Leave your details to receive consultation for the Summer Sale 2026 program and other promotions",
      name: "Full name",
      phone: "Phone number",
      email: "Email",
      namePlaceholder: "Enter your full name",
      ...
      submitting: "Submitting...",
      successTitle: "Thank you!",
      successDescription: "Your request has been sent successfully. We will contact you as soon as possible.\n\nNote: Because the promotion is running across both online and offline channels, product stock status changes minute by minute. To secure your benefits and avoid missing the offer, please message nanoHome directly on Zalo. Our live chat team will prioritize helping you check stock and reserve your order as quickly as possible.",
  ...
  ko: {
    ...
    cartModal: {
      ...
      collapsedCta: "CLICK HERE",
      description: "Summer Sale 2026 프로그램 및 기타 프로모션 상담을 위해 정보를 남겨 주세요",
      name: "성함",
      phone: "전화번호",
      email: "이메일",
      namePlaceholder: "성함을 입력하세요",
      ...
      submitting: "전송 중...",
      successTitle: "감사합니다!",
      successDescription: "요청이 성공적으로 전송되었습니다. 빠른 시간 내에 연락드리겠습니다.\n\n안내: 이번 프로모션은 온라인과 오프라인 채널에서 동시에 진행되고 있어 상품 재고 상태가 매분 변동될 수 있습니다. 혜택을 놓치지 않고 빠르게 확인하시려면 nanoHome Zalo로 직접 메시지를 보내 주세요. 실시간 채팅 팀이 재고 확인과 주문 확보를 우선적으로 도와드리겠습니다.",
